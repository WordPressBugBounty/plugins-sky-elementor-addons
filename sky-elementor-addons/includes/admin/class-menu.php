...
class Menu {
	...
	public static function get_b64_icon() {
		static $icon = null;
		if ( null === $icon ) {
			$icon = 'data:image/svg+xml;base64,' . base64_encode( file_get_contents( SKY_ADDONS_ASSETS_PATH . 'images/icon-mono.svg' ) ); // phpcs:ignore WordPress.WP.AlternativeFunctions
		}
		return $icon;
	}
