...
if ( ! function_exists( 'sky_addons_get_icon' ) ) {
	function sky_addons_get_icon() {
		return '<span class="sky-ctrl-section-icon-wrapper"><img src="' . SKY_ADDONS_ASSETS_URL . 'images/app-icon-256x256.png" class="sky-ctrl-section-icon" alt="Sky Addons" title="Sky Addons"></span>';
	}
}
